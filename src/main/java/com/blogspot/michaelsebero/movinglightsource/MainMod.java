...
import com.blogspot.michaelsebero.movinglightsource.proxy.CommonProxy;
...
@Mod( modid = MainMod.MODID, 
      ...
      guiFactory = "com.blogspot.michaelsebero."+MainMod.MODID+".gui.GuiFactory",
...
public class MainMod
{
    ...
    public static final String MODURL = "www.michaelsebero.blogspot.com";
